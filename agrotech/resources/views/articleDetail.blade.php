            ...
            <div class="col-lg-8 col-xl-9">
                <div class="row g-4">
                    <div class="row justify-content-center">
                        <div class="col-lg-12"> <!-- Use col-lg-12 to make the image span full width -->
                            <div class="rounded">
                                <a href="#">
                                    <img src="{{asset($article->picture)}}" class="img-fluid  rounded" width="600" alt="Image">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-lg-8 text-center"> <!-- Adjust col-lg-8 according to your design -->
                            <h5 class="fw-bold mt-3 mb-3">{{$article->title}}</h5>
